        ...
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="mt-8 md:mt-0">
            <p className="text-center md:text-right text-sm text-gray-500">
              &copy; {currentYear} RateMyStore. All rights reserved.
            </p>
            <p className="text-center md:text-right text-sm text-gray-500 mt-1">
              Made with <Heart className="h-4 w-4 inline text-error-500" /> for store owners and shoppers
            </p>
          </div>
        </div>
        <div className="mt-8 border-t border-gray-200 pt-8">
          <div className="flex flex-col md:flex-row justify-center md:justify-between space-y-4 md:space-y-0">
            <nav className="flex flex-wrap justify-center md:justify-start gap-6">
              ...
              <Link to="/contact" className="text-sm text-gray-600 hover:text-primary-500 transition-colors">
                Contact
              </Link>
            </nav>
